...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KINGPAPA OS — Los REYES de esta pendeja’" },
      { name: "description", content: "Salchipapas monstruosas, bowls coronados y retos para verdaderos súbditos del Reino. Cali, Bogotá, Jamundí y Medellín." },
      { name: "author", content: "KINGPAPA" },
      { property: "og:title", content: "KINGPAPA OS — Los REYES de esta pendeja’" },
      { property: "og:description", content: "El Sistema Operativo del Reino: pide, corónate, conviértete en súbdito." },
