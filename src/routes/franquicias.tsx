...
function FranquiciasPage() {
  return (
    <>
      ...
      <section className="bg-kp-ink text-kp-cheese border-b-4 border-kp-ink">
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-20">
          ...
          <p className="mt-5 max-w-2xl text-base md:text-lg">
            ...
            (10 Cali, 1 Jamundí, 4 Bogotá), una comunidad digital de <strong>+3 millones</strong> de
            fans y vamos por <strong>50 puntos al 2030</strong>. Esto no es una salchipapería: es
            una plataforma de marca lista para escalar contigo.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <BrutalCard tone="yellow" className="p-5">
            ...
            <p className="text-sm mt-2">
              49.008 (2021) → 197.224 (2022) → 228.191 (2023) → +280k (2025). Crecimientos de +391%
              y +32,6% en la evolución de la marca.
            </p>
          </BrutalCard>
          <BrutalCard tone="cheese" className="p-5">
            ...
            <p className="text-sm mt-2">
              10 en Cali, 1 en Jamundí, 4 en Bogotá. Meta pública: 50 puntos sostenibles al 2030.
            </p>
          </BrutalCard>
          <BrutalCard tone="purple" className="p-5">
            ...
            <p className="text-sm mt-2">
              TikTok 1.8M (<strong>#1 restaurante en Colombia</strong>), Instagram 675k, YouTube
              53k, Facebook activo. La comunidad digital más grande del sector.
            </p>
          </BrutalCard>
          <BrutalCard tone="red" className="p-5">
            ...
            <p className="text-sm mt-2">
              Desde el día uno usamos la marca para dar visibilidad a causas locales. Reino con
              propósito BIC.
            </p>
          </BrutalCard>
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={x.c} className="border-2 border-kp-ink p-3 text-center bg-kp-cheese">
                  ...
                  <BrutalBadge tone={x.t} className="mt-2">
                    {x.e}
                  </BrutalBadge>
                </div>
              ))}
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-6 py-12">
        <SectionHeading eyebrow="Historia que desarma objeciones" title="Del garaje al Reino" />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <BrutalCard tone="black" className="p-5">
            ...
            <p className="text-sm mt-2">
              El Limonar, Cali. Solo domicilios. Cero pretensión, todo hambre brava.
            </p>
          </BrutalCard>
          <BrutalCard tone="black" className="p-5">
            ...
            <p className="text-sm mt-2">
              Salto a Bogotá, primer puesto en TikTok entre restaurantes colombianos y +280k
              tickets/año.
            </p>
          </BrutalCard>
          <BrutalCard tone="black" className="p-5">
            ...
            <p className="text-sm mt-2">
              Modelo mixto franquicias + puntos propios. Roadmap público, no humo.
            </p>
          </BrutalCard>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              { n: "01", t: "Postulación", d: "Llenas el formulario de abajo. 3 minutos." },
              {
                n: "02",
                t: "Aplicación formal",
                d: "Te enviamos el dossier completo y validamos perfil.",
              },
              { n: "03", t: "Verificación", d: "Informe de capacidad financiera y operativa." },
              {
                n: "04",
                t: "Entrevistas",
                d: "Conoces a la BANDA fundadora y al equipo de expansión.",
              },
      ...
      <section id="aplicar" className="mx-auto max-w-3xl px-4 md:px-6 py-12">
        ...
        <div className="mt-6 text-center">
          ...
          <p className="font-display uppercase mt-1">
            <a
              href="mailto:kingpapacali@gmail.com"
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <BrutalCard tone="purple" className="p-5">
            ...
            <p className="text-sm mt-2">
              Clientes, colaboradores, proveedores, comunidad e inversionistas: un Reino donde todos
              GANEMOS. Gobernanza responsable, no postureo.
            </p>
          </BrutalCard>
          <BrutalCard tone="purple" className="p-5">
            <h3 className="font-display text-2xl uppercase">Talento que sostiene la corona</h3>
            <p className="text-sm mt-2">
              Los colaboradores son el motor del Reino. Capacitación constante, plan carrera y un
              círculo virtuoso: colaborador feliz → cliente exaltado → marca que evoluciona.
            </p>
          </BrutalCard>
          <BrutalCard tone="purple" className="p-5">
            <h3 className="font-display text-2xl uppercase">Comunidad y causas</h3>
            <p className="text-sm mt-2">
              +200 fundaciones apoyadas desde el inicio. Usamos la comunidad digital más grande del
              sector para amplificar causas locales que merecen ser vistas.
            </p>
          </BrutalCard>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <BrutalCard tone="cheese" className="p-5">
              ...
              <p className="text-sm mt-2">
                15 sedes en menos de 5 años desde un garaje. Tickets multiplicados x7 entre 2021 y
                2025.
              </p>
            </BrutalCard>
            <BrutalCard tone="cheese" className="p-5">
              ...
              <p className="text-sm mt-2">
                Ratings altos en apps, productos de ticket medio-alto y gramajes generosos que
                fidelizan. No vendemos papas: vendemos pertenecer al Reino.
              </p>
            </BrutalCard>
            <BrutalCard tone="cheese" className="p-5">
              <p className="font-display text-3xl">03 · Propósito BIC</p>
              <p className="text-sm mt-2">
                Roadmap claro a 50 puntos sostenibles al 2030, modelo mixto franquicia + propio, con
                declaración de impacto registrada.
              </p>
            </BrutalCard>
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 md:px-6 py-16 text-center">
        ...
        <h2 className="font-display text-4xl md:text-7xl uppercase leading-[0.95] mt-4">
          El Reino no se hereda.
          <br />
          <span className="text-kp-red">Se conquista.</span>
        </h2>
        <p className="mt-4 text-base md:text-lg max-w-2xl mx-auto">
          Los pioneros de hoy son las leyendas de 2030. Si crees que tu ciudad merece KINGPAPA, este
          es el momento de levantar la corona.
        </p>
