    ...
    <BrutalButton type="button" variant="ghost" block onClick={handleGoogle}>
      <span className="inline-flex items-center gap-2">
        <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
          <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.1 29.3 35 24 35c-6.1 0-11-4.9-11-11s4.9-11 11-11c2.8 0 5.4 1 7.4 2.8l5.7-5.7C33.6 6.7 29.1 5 24 5 13.5 5 5 13.5 5 24s8.5 19 19 19 19-8.5 19-19c0-1.2-.1-2.3-.4-3.5z" />
          <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16 19 13 24 13c2.8 0 5.4 1 7.4 2.8l5.7-5.7C33.6 6.7 29.1 5 24 5 16.3 5 9.7 9.3 6.3 14.7z" />
          <path fill="#4CAF50" d="M24 43c5 0 9.6-1.9 13-5l-6-5c-2 1.4-4.4 2.2-7 2.2-5.3 0-9.7-2.9-11.3-7l-6.6 5.1C9.5 38.7 16.2 43 24 43z" />
          <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.3 5.5l6 5C40.9 35 43 30 43 24c0-1.2-.1-2.3-.4-3.5z" />
        </svg>
        {label}
      </span>
    </BrutalButton>
